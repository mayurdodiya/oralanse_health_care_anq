...
module.exports = {
    ...
    modifyOrderRes: (responseData) => {
        // console.log(JSON.parse(JSON.stringify(responseData.data[0])));
        // console.log(JSON.parse(JSON.stringify(responseData.data[0].orderDetails[0].status)));
        // console.log(JSON.parse(JSON.stringify(responseData.data[0].orderDetails[0].ecom_products.name)));
