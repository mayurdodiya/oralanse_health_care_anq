...
exports.getAllNotification = async (req, res) => {
  try {
    ...
    const notification = await commonServices.getAll(Notification, { where: { user_id: userId, profile_type: options.PortalType.PATIENT, ...searchData }, attributes: { exclude: ["updatedAt"] } })
...
exports.readNotification = async (req, res) => {
  try {
    ...
    const notification = await commonServices.get(Notification,
      {
        where: { user_id: userId, profile_type: options.PortalType.PATIENT, id: notification_id },
